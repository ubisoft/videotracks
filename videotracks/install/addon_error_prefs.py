...
class UAS_ShotManager_AddonErrorPrefs(AddonPreferences):
    ...
    def draw(self, context):
        layout = self.layout
        prefs_addon = context.preferences.addons["videotracks"].preferences
        ...
        doc_op = rowRight.operator("videotracks.open_documentation_url", text="Video Tracks FAQ")
        doc_op.path = "https://ubisoft-videotracks.readthedocs.io/en/latest/troubleshoot/faq.html#installation"
...
def register():
    prefs_addon = bpy.context.preferences.addons["videotracks"].preferences
